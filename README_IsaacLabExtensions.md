...
```bash
python -m pip install -e source/humarconoid
```
...
We provide an example UI extension that will load upon enabling your extension defined in `source/humarconoid/humarconoid/ui_extension_example.py`.
...
```json
{
    "python.analysis.extraPaths": [
        "<path-to-ext-repo>/source/humarconoid"
    ]
}
```
