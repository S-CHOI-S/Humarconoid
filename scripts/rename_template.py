...
It renames all the occurrences of arc_lab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the arc_lab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "arc_lab", "arc_lab"),
            os.path.join(root_dir_path, "exts", "arc_lab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "arc_lab"), os.path.join(root_dir_path, "exts", new_name))
