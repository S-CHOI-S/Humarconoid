...
It renames all the occurrences of humarconoid (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the humarconoid folder
        os.rename(
            os.path.join(root_dir_path, "exts", "humarconoid", "humarconoid"),
            os.path.join(root_dir_path, "exts", "humarconoid", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "humarconoid"), os.path.join(root_dir_path, "exts", new_name))
