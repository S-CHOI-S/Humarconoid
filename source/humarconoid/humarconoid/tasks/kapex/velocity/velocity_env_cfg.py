...
class ActionsCfg:
    ...
    joint_pos = mdp.JointPositionActionCfg(asset_name="robot", joint_names=["^(?!.*LJ7).*"], scale=0.5, use_default_offset=True)
...
class ObservationsCfg:
    ...
    class CriticCfg(PolicyCfg):
        joint_torques = ObsTerm(func=mdp.joint_torques, noise=Unoise(n_min=-0.1, n_max=0.1))
...
class LocomotionVelocityRoughEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.sim.physx.gpu_max_rigid_patch_count = 250000  # increase GPU rigid patch count for large environments
