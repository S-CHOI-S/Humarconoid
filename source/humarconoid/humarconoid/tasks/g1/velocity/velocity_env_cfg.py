...
from humarconoid.tasks.g1.velocity import mdp
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = G1_KIST_WHOLEBODY_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class ARCRobotEnvCfg(ARCManagerBasedRLEnvCfg):
    """Configuration for the locomotion velocity-tracking environment."""
...
@configclass
class ARCRobotPlayEnvCfg(ARCRobotEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 32
        self.scene.terrain.terrain_generator.num_rows = 2
