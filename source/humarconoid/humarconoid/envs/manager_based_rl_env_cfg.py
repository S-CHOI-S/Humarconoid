...
@configclass
class ARCManagerBasedRLEnvCfg(ARCManagerBasedEnvCfg):
    ...
    * **Infinite horizon**: the agent needs to bootstrap the value of the state at the end of the episode.
    ...
    Note:
        The base :class:`ARCManagerBasedRLEnv` class does not use this flag directly. It is used by the environment
